...
def motoroutputs():
    motor_label_1 = ctk.CTkLabel(master=rw_outputs, text='X: ', font=body, text_color='black')
    motor_label_1.grid(padx=5, pady=1, row=1, column=0, sticky='w')
    motor_label_2 = ctk.CTkLabel(master=rw_outputs, text='Y: ', font=body, text_color='black')
    motor_label_2.grid(padx=5, pady=1, row=2, column=0, sticky='w')
    motor_label_3 = ctk.CTkLabel(master=rw_outputs, text='Z: ', font=body, text_color='black')
...
ctk.CTkLabel(master=attitude_outputs, text='Attitude Output', font=title, text_color='black').grid(row=0, column=0, columnspan=1, padx=70)
